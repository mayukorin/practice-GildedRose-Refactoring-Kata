...
public class BackstagePassesTest {
    ...
    public void testQualityIncreasesByOneWhen11DaysOrMore() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 11, 10);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityIncreasesByTwoWhen10Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 10, 10);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityIncreasesByTwoWhen6To10Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 6, 10);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityIncreasesByThreeWhen5Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 5, 10);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityIncreasesByThreeWhen1To5Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 1, 10);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityNeverMoreThan50When11DaysOrMore() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 11, 50);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityNeverMoreThan50When10Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 10, 50);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityNeverMoreThan50When5Days() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 5, 50);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
    ...
    public void testQualityNeverMoreThan50When5DaysBoundary48() {
        // Given: 初期状態の準備
        final Item item = new Item("Backstage passes to a TAFKAL80ETC concert", 5, 48);
        final BackstagePassesStrategy strategy = new BackstagePassesStrategy();
