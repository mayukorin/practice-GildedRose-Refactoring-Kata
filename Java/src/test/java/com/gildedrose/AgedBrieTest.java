...
public class AgedBrieTest {
    ...
    public void testQualityIncreasesByOneBeforeSellDate() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", 3, 10);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
    ...
    public void testQualityIncreasesByTwoOnSellDate() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", 0, 10);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
    ...
    public void testQualityIncreasesByTwoAfterSellDate() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", -1, 10);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
    ...
    public void testQualityNeverMoreThan50BeforeSellDate() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", 3, 50);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
    ...
    public void testQualityNeverMoreThan50AfterSellDate() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", -1, 50);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
    ...
    public void testQualityNeverMoreThan50WhenBoundary() {
        // Given: 初期状態の準備
        final Item item = new Item("Aged Brie", 0, 49);
        final AgedBrieStrategy strategy = new AgedBrieStrategy();
